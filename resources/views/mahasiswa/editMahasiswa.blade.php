    ...
    <div class="container">
        ...
        <div class="row">
            ...
            @csrf
                ...
                <input type="text" class="form-control @error('nama') is-invalid @enderror" placeholder="Nama lengkap" aria-label="Username" aria-describedby="basic-addon1" name="nama" id="nama" value="{{$student->nama}}">
                @error('nama')
                ...
                <div class="input-group mb-3">
                <input type="number" class="form-control @error('nim') is-invalid @enderror" placeholder="NIM Mahasiswa" name="nim" id="nim" value="{{$student->nim}}">
                ...
                <input type="email" class="form-control" name="email" id="email" placeholder="example@example.com" value="{{$student->email}}">
                @error('email')
                ...
                <input type="text" class="form-control @error('jurusan') is-invalid @enderror" placeholder="Jurusan Kuliah" name="jurusan" id="jurusan" value="{{$student->jurusan}}">
                @error('jurusan')
